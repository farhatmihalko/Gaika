	...
	<!--page content-->
		<div class="seven columns centered login shadow">
			...
			<form action="" method="POST">
				<input type="text" placeholder="Введите ваше имя сюда" 
				class="line-after-big line-before-big" name="name">
				<input type="password" placeholder="Тут надо написать пароль" 
				class="line-after-big" name="password">
				...
				<a href="<?php echo base_url();?>index.php/main/restore_password" 
					class="right font-gray-bold">
					<i class="icon-refresh pad-right"></i>Забыл пароль
				</a>
				<div class="line-before pad">
